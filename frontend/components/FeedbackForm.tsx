...
export function FeedbackForm() {
    ...
    const isFormValid = formData.title.trim().length > 0 && formData.description.trim().length >= 20 && formData.category;
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    className={`w-full px-4 py-3 rounded-lg border transition-all outline-none placeholder:text-gray-500 ${
                        errors.title ? "border-red-500 focus:ring-2 focus:ring-red-200" : "border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                    }`}
                />
                <div className="flex justify-between items-start mt-1">
                    <p className="text-xs text-red-500 font-medium">{errors.title ? errors.title : " "}</p>
            ...
            <div>
                ...
                <textarea
                    ...
                    className={`w-full px-4 py-3 rounded-lg border transition-all outline-none resize-none placeholder:text-gray-500 ${
                        errors.description ? "border-red-500 focus:ring-2 focus:ring-red-200" : "border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                    }`}
                />
                <div className="flex justify-between items-start mt-1">
                    <p className="text-xs text-red-500 font-medium">{errors.description ? errors.description : " "}</p>
                    <p className={`text-xs ${formData.description.trim().length < 20 ? "text-red-500" : "text-gray-500"}`}>{formData.description.length}/5000</p>
                </div>
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    className={`w-full px-4 py-3 rounded-lg border transition-all outline-none ${
                        errors.category ? "border-red-500 focus:ring-2 focus:ring-red-200" : "border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                    }`}
                >
                ...
                <p className="text-xs text-red-500 font-medium mt-1">{errors.category ? errors.category : " "}</p>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all placeholder:text-gray-500"
                />
                <p className="text-xs text-gray-500 mt-1">We'll use this only if we need to follow up about your feedback.</p>
            </div>

            {/* Success/Error Message */}
            {message && (
                <div className={`p-4 rounded-lg border transition-all ${message.type === "success" ? "bg-green-50 border-green-200 text-green-800" : "bg-red-50 border-red-200 text-red-800"}`}>
            ...
            {/* Privacy Notice */}
            <p className="text-xs text-gray-600 text-center">Your feedback is secure and private. We never share your email with third parties.</p>
